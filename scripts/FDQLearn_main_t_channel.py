...
train_std_file = '../data/training_test_results/t_channel/parametrized_t_channel_train_std_5l.txt'

val_std_file = '../data/training_test_results/t_channel/parametrized_t_channel_val_std_5l.txt'

angle_file = '../data/training_test_results/t_channel/parametrized_t_channel_angles_5l.txt'

momenta_file = '../data/training_test_results/t_channel/parametrized_t_channel_momenta_5l.txt'
