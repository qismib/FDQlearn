...
train_std_file = '../data/training_test_results/e_mu/parametrized_e_mu_train_std_3l.txt'

val_std_file = '../data/training_test_results/e_mu/parametrized_e_mu_val_std_3l.txt'

angle_file = '../data/training_test_results/e_mu/parametrized_e_mu_angles_3l.txt'

momenta_file = '../data/training_test_results/e_mu_massive/parametrized_e_mu_momenta_3l.txt'
