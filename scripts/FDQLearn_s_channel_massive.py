...
train_file = '../data/training_test_results/s_channel_massive/parametrized_s_channel_train_loss_massive_3l.txt'

val_file = '../data/training_test_results/s_channel_massive/parametrized_s_channel_val_loss_massive_3l.txt'

test_pred_file = '../data/training_test_results/s_channel_massive/parametrized_s_channel_predictions_massive_3l.txt'

truth_file = '../data/training_test_results/s_channel_massive/parametrized_s_channel_ground_truth_massive_3l.txt'
